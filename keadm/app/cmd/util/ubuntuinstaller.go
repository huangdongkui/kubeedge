...
SKIPDOWNLOADAND:
	untarFileAndMove := fmt.Sprintf("cd %s && tar -C %s -xvzf %s && cp -r %skubeedge/edge/%s %s/.", KubeEdgePath, KubeEdgePath, filename, KubeEdgePath, KubeEdgeBinaryName, KubeEdgeUsrBinPath)
